...
import { ExtendedListingWrapper } from "../reducers/listings";
...
export const makeGetListingWhitelistedTimestamp = () => {
  return createSelector([getListingWrapper], listingWrapper => {
    return listingWrapper ? listingWrapper.whitelistedTimestamp : undefined;
  });
};

export const makeGetListingRemovedTimestamp = () => {
  return createSelector([getListingWrapper], listingWrapper => {
    return listingWrapper ? listingWrapper.removedTimestamp : undefined;
  });
};
