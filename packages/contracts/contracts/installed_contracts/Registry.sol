...
contract Registry {
    ...
    */
    function apply(bytes32 _listingHash, uint _amount, string _data) public {
    ...
    */
    function challenge(bytes32 _listingHash, string _data) public returns (uint challengeID) {
        Listing storage listing = listings[_listingHash];
